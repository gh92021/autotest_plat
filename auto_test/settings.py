...
SECRET_KEY = 'django-insecure-tfnx61i3=14l6#)psp%yx=!np-ig^!j^_xt8oaw$fb=l7^&4by'
...
LOCUST_SCRIPTS_DIR = BASE_DIR / 'locust_scripts'
TEST_DATA_DIR = BASE_DIR / 'locust_test_data'
REPORTS_DIR = BASE_DIR / 'locust_reports'
